...
- `apps/api`: NestJS modular-monolith entry point, HTTP runtime middleware, global error handling, database provider/lifecycle integration, authentication HTTP adapter/guards, and safe operational endpoints.
